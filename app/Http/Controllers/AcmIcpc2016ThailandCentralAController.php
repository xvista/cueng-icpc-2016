    ...
    public function index()
    {
        $gallery = [
            ...
            'contest' => [
                ...
                'คุณอัครพนธ์ วัชรพลากร มอบรางวัลพิเศษให้ทีม  จาก ',
                'คุณอัครพนธ์ วัชรพลากร มอบรางวัลพิเศษให้ทีม  จาก ',
                'ดร.ฑิตยา หวานวารี มอบรางวัลชมเชยให้ทีม  จาก Chulalongkorn University',
                'ศาสตราจารย์ ดร.ประภาส จงสถิตวัฒนา มอบรางวัลรองชนะเลิศอันดับสองให้ทีม  จาก Chulalongkorn University',
                'ศาสตราจารย์ ดร.ประภาส จงสถิตวัฒนา มอบรางวัลรองชนะเลิศอันดับหนึ่งให้ทีม  จาก Chulalongkorn University',
                'ศาสตราจารย์ ดร.ประภาส จงสถิตวัฒนา มอบรางวัลชนะเลิศอันดับหนึ่งให้ทีม  จาก Chulalongkorn University',
